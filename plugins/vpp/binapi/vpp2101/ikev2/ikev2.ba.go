...
// IPFeatureLocation represents VPP binary API enum 'ip_feature_location'.
...
var IPFeatureLocation_name = map[uint8]string{
...
var IPFeatureLocation_value = map[string]uint8{
...
// Ikev2ProfileDisableNatt represents VPP binary API message 'ikev2_profile_disable_natt'.
...
func (*Ikev2ProfileDisableNatt) GetMessageType() api.MessageType { return api.RequestMessage }

// Ikev2ProfileDisableNattReply represents VPP binary API message 'ikev2_profile_disable_natt_reply'.
...
func (*Ikev2ProfileDisableNattReply) GetMessageType() api.MessageType { return api.ReplyMessage }
...
func init() {
	...
	api.RegisterMessage((*Ikev2ProfileDisableNatt)(nil), "ikev2.Ikev2ProfileDisableNatt")
	api.RegisterMessage((*Ikev2ProfileDisableNattReply)(nil), "ikev2.Ikev2ProfileDisableNattReply")
