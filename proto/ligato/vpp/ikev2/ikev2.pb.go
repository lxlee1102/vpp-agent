...
type Profile struct {
	...
	Auth            *Profile_Auth            `protobuf:"bytes,2,opt,name=auth,proto3" json:"auth,omitempty"`
	...
	TrafficSelector *Profile_TrafficSelector `protobuf:"bytes,10,opt,name=traffic_selector,json=trafficSelector,proto3" json:"traffic_selector,omitempty"`
}
...
var file_ligato_vpp_ikev2_ikev2_proto_rawDesc = []byte{
	...
	0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x6c, 0x69, 0x67, 0x61, 0x74, 0x6f,
